...
[![dev branch](https://img.shields.io/badge/branch-dev-blue?style=flat&logo=git&logoColor=white)](https://github.com/RH-NAYM/OpenCV-Convolution/tree/dev)
#
...
# 📌 Overview
This project provides a deep dive into image filtering techniques using **convolution** in **OpenCV**. Inspired by resources like `OpenCV`, it covers foundational concepts to advanced topics, including theoretical explanations, mathematical derivations, practical code implementations, and performance optimizations.
